...
namespace TheRiptide
{
    ...
    public static class SpectatorVisibility
    {
        ...
        {
            if (player_matchup.ContainsKey(target.characterClassManager.UserId))
            {
                Matchup matchup = player_matchup[target.characterClassManager.UserId];
                if(matchup.opposition.Users.Contains(observer.characterClassManager.UserId))
                {
