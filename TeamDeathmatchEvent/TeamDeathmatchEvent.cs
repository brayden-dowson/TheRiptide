...
namespace TheRiptide
{
    ...
    public class TeamDeathmatchEvent:IEvent
    {
        ...
        [PluginEntryPoint("Team Deathmatch", "1.0.0", "scientists vs class-d in a random zone with a random weapon", "The Riptide")]
